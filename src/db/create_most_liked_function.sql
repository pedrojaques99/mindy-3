-- Function to get resources ordered by the number of favorites
CREATE OR REPLACE FUNCTION get_most_liked_resources(limit_count INTEGER DEFAULT 6)
...
GRANT EXECUTE ON FUNCTION get_most_liked_resources TO anon, authenticated;